               ...
               uint32_t dwellA, uint32_t dwellB)
{
  ...
  sendByte(address, INC_STRUCT_TOP + 3, servoID);
  sendByte(address, INC_STRUCT_TOP + 4, mode);
  sendWord(address, INC_STRUCT_TOP + 5, posA);
  sendWord(address, INC_STRUCT_TOP + 7, posB);
  sendLWord(address, INC_STRUCT_TOP + 9, dwellA);
  sendLWord(address, INC_STRUCT_TOP + 13, dwellB);
  sendByte(address, INC_STRUCT_TOP + 17, 0);
  sendByte(address, INC_STRUCT_TOP + 18, 0);
  sendWord(address, INC_STRUCT_TOP + 19, 0);
  sendLWord(address, INC_STRUCT_TOP + 21, 0);
               ...
               int32_t postdelay, int32_t audioTimer)
{
  ...
  sendByte(address, INC_STRUCT_TOP + 5, pending);
  sendLWord(address, INC_STRUCT_TOP + 6, predelay);
